	...
	<div id="page" class="site">
		...
		<header id="masthead" class="site-header w-100" role="banner">
			...
			<?php if ( get_header_image() && is_front_page() ) : ?>
				<div class="vh-50 w-100 pa0 ma0 cover bg-center flex flex-column justify-center items-center" style="background-image: url('<?php header_image(); ?>');">
					<h1 class="site-title white ttu f4 f2-ns f1-l lh-title ph2 tc">
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="link white medium">Venezuelan <span class="extrabold wola-blue">Politics</span><br> and <span class="extrabold wola-blue">Human Rights</span></a>
					</h1>
					<div class="flex items-center justify-end">
						<p class="site-description white ph2 ttu f6 f5-l i tc"><span class="bold">Independent, Reality-Based Analysis</span></br><span class="medium">Curated by David Smilde</span></p>
					</div>
				</div>
			<?php endif; ?>
			...
			<div class="w-100 bg-wola-gray pa0 ma0">		
				<div class="mw8-5 center pa3 ma0 flex justify-between items-center">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" alt="home">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/logos/logo2.png" alt="WOLA Logo" class="ph2" style="max-height: 4rem; width: auto;">
					</a>
					<nav id="site-navigation" class="main-navigation ma0 flex flex-column justify-end items-end" role="navigation">
