...
<body <?php body_class(); ?>>
	<div id="page" class="site">
		...
		<header id="masthead" class="site-header w-100" role="banner">
			...
			<div class="w-100 bg-wola-gray pv0 pa0 ma0">	
				
				<nav id="site-navigation" class="main-navigation mw8-5 center pa3 ma0 flex justify-between items-end relative" role="navigation" style="height: 6rem">
					
					<?php wp_nav_menu( array( 'theme_location' => 'menu-1', 'menu_id' => 'primary-menu', 'menu_class' => 'link white flex items-center ph3 pv0 ma0 list fw3 f7', 'container_class' => 'flex items-end',  ) ); ?>
					
					<div class="logo">
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" alt="home">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/logos/logo2.png" alt="WOLA Logo" class="h-auto mw5-ns mw4">
						</a>
					</div>

					<div class="flex items-end">
						<ul class="link white flex items-center list mb2">
							<li class="flex items-center">
								<a href="#" class="link dim white dib h1-5 w1-5 mr3">
							...
							<li class="flex items-center">
								<a class="link dim white dib h1-5 w1-5 mr3" href="#" title="">
							...
							<li class="flex items-center"><a href="https://wola.org" class="link white dim fw3 f7 system">WOLA.org</a></li>
						</ul>
					</div>
			...
			<?php if ( get_header_image() && is_front_page() ) : ?>
				<div class="w-100 pa0 ma0 cover bg-center" style="background-image: url('<?php header_image(); ?>');">
					<div class="pv5-l pv4-ns pv3 flex flex-column justify-center items-center">
						<h1 class="site-title white ttu f4 f2-ns f1-l lh-title ph2 tc">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="link white bold">Venezuelan <span class="extrabold wola-blue">Politics</span><br> and <span class="extrabold wola-blue">Human Rights</span></a>
						</h1>
						<div class="flex items-center justify-end">
							<p class="site-description white ph2 ttu f6 f5-ns f4-l i tc"><span class="bold">Independent, Reality-Based Analysis</span></br><span class="medium">Curated by David Smilde</span></p>
						</div>
					</div>
				</div>
			<?php endif; ?>
